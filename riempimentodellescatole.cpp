...
void riempimentodellescatole(int id){
  while (fineproduzione < 2){ //controllo che la produzione non sia finita
    ...
    if (postazioneoccupata){  //serve per la fine della produzione: vengono sbloccati entrambi i robot e bisogna far si che non portino due volte
                              //la scatola a magazzino
